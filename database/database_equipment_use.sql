...
CREATE TABLE `equipment_use` (
  ...
  PRIMARY KEY (`userid`,`equipmentid`,`time`),
  KEY `equipmentid_idx` (`equipmentid`),
  CONSTRAINT `equipmentid` FOREIGN KEY (`equipmentid`) REFERENCES `equipment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2016-11-25 17:00:55
